    ...
    return (
        <div className="fixed top-0 left-0 h-full w-72 bg-white shadow-lg z-40 border-r border-gray-100">
            ...
            <nav className="p-4 space-y-2">
                ...
                <Link 
                    href="/"
                    className="w-full flex items-center space-x-3 px-3 py-2 text-gray-800 hover:text-[#354eab] hover:bg-[#f8faff] font-semibold rounded-lg transition-all duration-300 ease-out group border border-transparent hover:border-[#354eab]/20"
                >
                    <div className="w-9 h-9 bg-gradient-to-br from-[#354eab] to-[#4a5fc7] rounded-lg flex items-center justify-center group-hover:scale-110 transition-all duration-300 ease-out shadow-sm">
