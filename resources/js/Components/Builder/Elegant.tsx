...
const Elegant: React.FC<Props> = ({ resumeData }) => {
  ...
  return (
    <div className="text-[#333333] bg-white leading-[1.35] p-6 md:p-8 max-w-[850px] mx-auto elegant-template" style={{ fontFamily: "'Elegant Grotesk', 'Helvetica Neue', Arial, sans-serif" }}>
      <style
        dangerouslySetInnerHTML={{
          __html: `
            ...
            .elegant-name { font-size: 34px; font-weight: 800; letter-spacing: 0.18em; }
            .elegant-title { font-size: 11px; text-transform: uppercase; letter-spacing: 0.34em; font-weight: 700; }
            .elegant-section-title { font-size: 11px; font-weight: 800; text-transform: uppercase; letter-spacing: 0.26em; }
          `,
        }}
      />
      ...
      <div className="relative text-center mb-6">
        ...
        {true && (
          <div className="absolute inset-0 flex items-center justify-center pointer-events-none select-none" style={{ zIndex: 0 }} aria-hidden>
            <span style={{ fontFamily: '"Brush Script MT", "Segoe Script", "Pacifico", cursive', fontSize: 120, lineHeight: 1, opacity: 0.08, transform: 'translateY(6px) rotate(-6deg)' }}>
              {`${(contact.firstName?.[0] || 'Y').toUpperCase()}${(contact.lastName?.[0] || 'N').toUpperCase()}`}
            </span>
          </div>
        )}
        <h1 className="elegant-name break-words" style={{ position: 'relative', zIndex: 1 }}>
          <Placeholder value={`${contact.firstName || ''} ${contact.lastName || ''}`.trim()} placeholder="YOUR NAME" />
        </h1>
        <p className="mt-1 elegant-title text-[#333333] break-words" style={{ position: 'relative', zIndex: 1 }}>
      ...
      <div className="border-t border-b border-gray-300">
        ...
        <div className="md:grid md:grid-cols-12">
          <div className="md:col-span-4 md:pr-0 md:border-r md:border-gray-300 py-4">
            <div className="pr-5">
              <h3 className="elegant-section-title mb-2">Contact</h3>
              <div className="space-y-1.5 text-[13px]">
                <div className="flex items-start gap-2">
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="mt-0.5 text-[#333333] flex-shrink-0"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6A19.79 19.79 0 0 1 2.1 4.16 2 2 0 0 1 4.06 2h3a2 2 0 0 1 2 1.72c.12.9.31 1.77.57 2.61a2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.47-1.09a2 2 0 0 1 2.11-.45c.84.26 1.71.45 2.61.57A2 2 0 0 1 22 16.92Z" stroke="#333" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/></svg>
                    <span className="break-words min-w-0 flex-1"><Placeholder value={contact.phone} placeholder="(123) 456-7890" /></span>
                  </div>
                <div className="flex items-start gap-2">
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="mt-0.5 text-[#333333] flex-shrink-0"><path d="M4 4h16a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2Z" stroke="#333" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/><path d="m22 6-10 7L2 6" stroke="#333" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/></svg>
                    <span className="break-all min-w-0 flex-1"><Placeholder value={contact.email} placeholder="email@example.com" /></span>
                  </div>
                <div className="flex items-start gap-2">
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="mt-0.5 text-[#333333] flex-shrink-0"><path d="M12 22s8-5.33 8-12a8 8 0 1 0-16 0c0 6.67 8 12 8 12Z" stroke="#333" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/><circle cx="12" cy="10" r="3" stroke="#333" strokeWidth="1.5"/></svg>
                  ...
                  <div className="space-y-1">
                    {websites.map((site) => (
                      <div key={site.id} className="flex items-start gap-2">
                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="mt-0.5 text-[#333333] flex-shrink-0"><circle cx="12" cy="12" r="9" stroke="#333" strokeWidth="1.5"/><path d="M3 12h18M12 3a15 15 0 0 1 0 18M12 3a15 15 0 0 0 0 18" stroke="#333" strokeWidth="1.5"/></svg>
                        <div className="text-[13px] min-w-0 flex-1 break-words">
                          <span className="font-medium mr-1">{site.label || 'Website'}:</span>
                          <a href={site.url} target="_blank" rel="noreferrer" className="underline text-[#333333] break-all hover:text-blue-600 transition-colors">
                            {site.url}
                          </a>
                        </div>
                      </div>
          ...
          <div className="md:col-span-8 py-4 md:pl-5">
            <h3 className="elegant-section-title mb-2">Profile Summary</h3>
            <p className="text-[12px] whitespace-pre-line break-words"><Placeholder value={summary} placeholder={"Use this section to give recruiters a quick glimpse of your professional profile. In just 3–4 lines, highlight your background, education and main skills."} /></p>
          </div>
        </div>
        ...
        <div className="border-t border-gray-300 md:grid md:grid-cols-12">
          <div className="md:col-span-4 md:pr-0 md:border-r md:border-gray-300 py-0">
            <div className="py-4 pr-5">
              <h3 className="elegant-section-title mb-2">Education</h3>
            ...
            <div className="py-4 pr-5">
                <h3 className="elegant-section-title mb-2">Skills</h3>
              <div className="space-y-2.5">
            ...
            {languages && languages.length > 0 && (
              <div className="py-4 pr-5">
                <h3 className="elegant-section-title mb-2">Languages</h3>
                <ul className="list-disc pl-5 text-[12px] space-y-1">
                  {languages.map((lang) => (
                    <li key={lang.id} className="break-words">
                      {lang.name}
            ...
            {hobbies && hobbies.length > 0 && (
              <div className="py-5 pr-6">
                ...
                <ul className="list-disc pl-5 text-[13px] space-y-1">
                  {hobbies.map((hobby) => (
                    <li key={hobby.id} className="break-words">{hobby.name}</li>
                  ))}
                </ul>
              </div>
            )}
                  ...
                  return (
                    <div key={exp.id}>
                      <div className="flex justify-between items-baseline mb-1">
                        <p className="text-[12px] font-semibold break-words min-w-0 flex-1 pr-2"><Placeholder value={exp.company} placeholder="Company" /></p>
        ...
        {(!!(certifications && certifications.length) || !!(awards && awards.length) || !!(references && references.length) || !!(customSections && customSections.length)) && (
          <div className="border-t border-gray-300 md:grid md:grid-cols-12">
            <div className="md:col-span-4 md:border-r md:border-gray-300" />
            <div className="md:col-span-8 py-4 md:pl-5">
              {customSections && customSections.length > 0 && (
                <div className="space-y-3.5 mb-3.5">
                  {customSections.map((custom) => (
                    <div key={custom.id}>
                      <p className="elegant-section-title mb-2 break-words">{custom.title}</p>
                      <p className="text-[12px] whitespace-pre-line break-words">{custom.content}</p>
                    </div>
                  ))}
                </div>
              )}
              ...
              {awards && awards.length > 0 && (
                <div className="mb-3.5">
                  ...
                  <ul className="list-disc pl-5 text-[12px] space-y-1">
                    {awards.map((award) => (
                      <li key={award.id} className="break-words">{award.title}</li>
                    ))}
                  </ul>
                </div>
              )}
