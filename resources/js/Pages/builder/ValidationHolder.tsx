        ...
        <div>
          <label className="block text-gray-700 mb-1">Phone number</label>
                    ...
                    <div className="absolute top-full left-0 mt-1 w-24 bg-white border border-slate-300 rounded-lg shadow-lg z-10">
                      <div className="py-1">
                        {(['US', 'PH', 'UK'] as PhoneCountry[]).map((country) => (
                          ...
                          >
                            <img
                              src={`/icons/${country === 'US' ? 'US' : country === 'PH' ? 'PH' : 'UK'}.svg`}
                              alt={country}
                              className="w-5 h-5"
                            />
              ...
              <input 
                type="tel"
                autoComplete="tel"
                className={`flex-1 min-w-0 border border-l-0 border-slate-300 rounded-r-md px-3 py-2 h-[49px] appearance-none bg-white outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-white transition-all duration-150 ease-in-out ${errors.phone ? 'border-red-500' : ''} placeholder-gray-400 focus:placeholder-transparent text-gray-900`}
