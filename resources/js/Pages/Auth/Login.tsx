                        ...
                        <div>
                            ...
                            <div className="relative">
                                <input
                                    ...
                                    className="w-full pl-4 pr-12 py-3 border-0 rounded-lg shadow-inner bg-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#354eab] focus:ring-opacity-50"
